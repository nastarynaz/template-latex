...
\section{PREAMBLE}
    ...
    \subsection{Abstract}
        ...
        The abstract text may contain several paragraphs, but it should not be overly long\footnote{this is a footnote}. The recommended length is 200 words for the abstract.
    
        The text for the {\bf abstract} is placed with the \verb|\begin{abstract} \end{abstract}| command.
...
\section{MAIN BODY}
    ...
    The first command after the \CS{begin}\verb+{document}+ should be \CS{maketitle}. This will format the Title, Author(s), Abstract, and Keywords sections.
